...
- Added the `AIHello` workflow to exercise the generic AI agent workflow and its
  task-input handling.
- Updated the AI agent workflows to use the merged generic project prompt and
  workflow configuration.

### ✅ Compatibility

- **No breaking changes**: this release only updates CI and development workflows;
  the Julia API and runtime behaviour are unchanged.
...
- **`Strategies.parameter` cross-references**: split the docstrings for the
  one-argument and two-argument `parameter` methods so their generated API
  anchors can be resolved independently by downstream documentation.

### ✅ Compatibility

- **No breaking changes**: documentation and generated API anchors only; no
  public signature, behavior, type, or name changed. No migration required.
...
- **Extensible references**: switched documentation cross-references to use
  `InterLinks`, improving references to symbols provided by extensions.

### ✅ Compatibility

- **No breaking changes**: documentation and CI configuration updates only.

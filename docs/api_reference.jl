...
function generate_api_reference(src_dir::String)
    ...
    modules_config = [
        (
            ...
            files=src(
                ...
                joinpath("Core", "tags.jl"),
                joinpath("Core", "caches.jl"),
                joinpath("Core", "not_provided.jl"),
                joinpath("Core", "matrix_utils.jl"),
                joinpath("Core", "function_utils.jl"),
                joinpath("Core", "macros.jl"),
                joinpath("Core", "palette.jl"),
                joinpath("Core", "display.jl"),
            ),
        ),
        (
            mod=CTBase.Data,
            ...
            files=src(
                ...
                joinpath("Data", "path_constraint.jl"),
                joinpath("Data", "abstract_multiplier.jl"),
                joinpath("Data", "multiplier.jl"),
                joinpath("Data", "abstract_pseudo_hamiltonian.jl"),
                joinpath("Data", "pseudo_hamiltonian.jl"),
                joinpath("Data", "composed_hamiltonian.jl"),
                joinpath("Data", "abstract_controlled_vector_field.jl"),
                joinpath("Data", "controlled_vector_field.jl"),
                joinpath("Data", "composed_vector_field.jl"),
            ),
        ),
        (
            mod=CTBase.Differentiation,
        ...
        (
            ...
            files=src(
                ...
                joinpath("Traits", "constraint_kind.jl"),
        ...
        (
            ...
            filename="plotting",
            files=src(
                joinpath("Plotting", "Plotting.jl"),
                joinpath("Plotting", "ir.jl"),
                joinpath("Plotting", "panel.jl"),
                joinpath("Plotting", "combinators.jl"),
                joinpath("Plotting", "lowering.jl"),
                joinpath("Plotting", "heuristics.jl"),
                joinpath("Plotting", "contract.jl"),
            ),
        ),
    ]
    ...
    for (sym, files) in [
        (
            ...
            ext(joinpath("CTBaseDifferentiationInterface.jl")),
        ),
        (
            :DocumenterReference,
            ext(

...
@test constraint_type(:( x(0)'                 ), t, t0, tf, x, u, v) == (:boundary, nothing)
@test constraint_type(:( x'(0)                 ), t, t0, tf, x, u, v) == (:boundary, nothing)
@test constraint_type(:( x(t)'                 ), t, t0, tf, x, u, v) == (:state_fun, nothing)
...
@test constraint_type(:( x[1:2](0)             ), t, t0, tf, x, u, v) == (:initial, 1:2)
@test constraint_type(:( 2x[1](0)^2            ), t, t0, tf, x, u, v) == (:boundary, nothing)
...
@test constraint_type(:( x[1:2](tf)            ), t, t0, tf, x, u, v) == (:final, 1:2)
@test constraint_type(:( x[1](tf) - x[2](0)    ), t, t0, tf, x, u, v) == (:boundary, nothing)
@test constraint_type(:( 2x[1](tf)^2           ), t, t0, tf, x, u, v) == (:boundary, nothing)
...
@test constraint_type(:( 2u[1](t)^2            ), t, t0, tf, x, u, v) == (:control_fun, nothing)
...
@test constraint_type(:( 2x[1](t)^2            ), t, t0, tf, x, u, v) == (:state_fun, nothing)
@test constraint_type(:( 2u[1](t)^2 * x(t)     ), t, t0, tf, x, u, v) == (:mixed, nothing)
@test constraint_type(:( 2u[1](0)^2 * x(t)     ), t, t0, tf, x, u, v) ==  :other
@test constraint_type(:( 2u[1](t)^2 * x(t) + v ), t, t0, tf, x, u, v) == (:mixed, nothing)

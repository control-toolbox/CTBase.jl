...
@test constraint_type(:( y'(t)                 ), t, t0, tf, x, u, v) == (:other, nothing)
@test constraint_type(:( x'(s)                 ), t, t0, tf, x, u, v) == (:other, nothing)
@test constraint_type(:( x(0)'                 ), t, t0, tf, x, u, v) == (:boundary, :(var"x#0"'))
@test constraint_type(:( x'(0)                 ), t, t0, tf, x, u, v) == (:other, nothing)
...
@test constraint_type(:( 2u[1](0)^2 * x(t)     ), t, t0, tf, x, u, v) == (:other, nothing)

    ...
    Test.@testset "AbstractVectorField Tests" verbose=VERBOSE showtiming=SHOWTIMING begin
        ...
        Test.@testset "Trait Accessors on Abstract Type" begin
            ...
            Test.@testset "time_dependence returns correct trait" begin
                fake_aut = FakeVectorField{
                    Traits.Autonomous,Traits.Fixed,Traits.OutOfPlace
                }()
                fake_nonaut = FakeVectorField{
            ...
            Test.@testset "variable_dependence returns correct trait" begin
                fake_fixed = FakeVectorField{
                    Traits.Autonomous,Traits.Fixed,Traits.OutOfPlace
                }()
                fake_nonfixed = FakeVectorField{
            ...
            Test.@testset "explicit dispatch on AbstractVectorField methods" begin
                ...
                Test.@test invoke(
                    Traits.has_time_dependence_trait, Tuple{Data.AbstractVectorField}, fake
                ) === true
                ...
                Test.@test invoke(
                    Traits.has_mutability_trait, Tuple{Data.AbstractVectorField}, fake
                ) === true

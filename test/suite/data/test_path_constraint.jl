...
function test_path_constraint()
    Test.@testset "PathConstraint Tests" verbose = VERBOSE showtiming = SHOWTIMING begin
        ...
        Test.@testset "Unit: construction and trait extractors" begin
            ...
            g1 = Data.StateConstraint(x -> x[1]; is_autonomous=true, is_variable=false)
            ...
            g3 = Data.MixedConstraint((x, u) -> x[1] + u[1])
        ...
        Test.@testset "Natural calls - StateConstraint" begin
            Test.@test Data.StateConstraint(x -> 2x[1])([3.0]) == 6.0
            Test.@test Data.StateConstraint((t, x) -> t + x[1]; is_autonomous=false)(
                1.0, [2.0]
            ) == 3.0
            Test.@test Data.StateConstraint((x, v) -> x[1] * v[1]; is_variable=true)(
                [2.0], [5.0]
            ) == 10.0
            Test.@test Data.StateConstraint(
        ...
        Test.@testset "Natural calls - ControlConstraint" begin
            Test.@test Data.ControlConstraint(u -> 2u[1])([3.0]) == 6.0
            Test.@test Data.ControlConstraint((t, u) -> t + u[1]; is_autonomous=false)(
                1.0, [2.0]
            ) == 3.0
            Test.@test Data.ControlConstraint((u, v) -> u[1] * v[1]; is_variable=true)(
                [2.0], [5.0]
            ) == 10.0
        end
        ...
        Test.@testset "Uniform call g(t, x, u, v)" begin
            ...
            # State: ignores u
            Test.@test Data.StateConstraint(x -> x[1])(t, x, u, v) == 2.0
            Test.@test Data.StateConstraint((t, x) -> t + x[1]; is_autonomous=false)(
                t, x, u, v
            ) == 3.0
            Test.@test Data.StateConstraint((x, v) -> x[1] + v[1]; is_variable=true)(
            ...
            # Control: ignores x
            Test.@test Data.ControlConstraint(u -> u[1])(t, x, u, v) == 3.0
            Test.@test Data.ControlConstraint((t, u) -> t + u[1]; is_autonomous=false)(
                t, x, u, v
            ) == 4.0
            Test.@test Data.ControlConstraint((u, v) -> u[1] + v[1]; is_variable=true)(
        ...
        Test.@testset "show" begin
            g = Data.MixedConstraint((x, u) -> x[1] + u[1])

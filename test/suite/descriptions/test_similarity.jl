...
function test_similarity()
    @testset verbose = VERBOSE showtiming = SHOWTIMING "Similarity Utilities" begin
        ...
        @testset "Type stability - compute_similarity" begin
            # Basic case
            @test (@inferred CTBase.Descriptions.compute_similarity((:a, :b), (:a, :c))) isa
                Float64

            # Edge cases
            @test (@inferred CTBase.Descriptions.compute_similarity((), ())) isa Float64
            @test (@inferred CTBase.Descriptions.compute_similarity((:a,), (:b,))) isa
                Float64
        ...
        @testset "find_similar_descriptions - boundaries" begin
            ...
            target = (:a,)
            similar = CTBase.Descriptions.find_similar_descriptions(
            ...
            similar2 = CTBase.Descriptions.find_similar_descriptions(
            ...
            similar3 = CTBase.Descriptions.find_similar_descriptions(
        ...
        @testset "find_similar_descriptions - edge cases" begin
            ...
            @test isempty(CTBase.Descriptions.find_similar_descriptions((:a,), ()))

            # Empty target
            descriptions = ((:a, :b), (:c, :d))
            @test isempty(CTBase.Descriptions.find_similar_descriptions((), descriptions))
        ...
        @testset "Type stability - find_similar_descriptions" begin
            ...
            @test (@inferred CTBase.Descriptions.find_similar_descriptions(
                target, descriptions
            )) isa Vector{String}
            @test (@inferred CTBase.Descriptions.find_similar_descriptions(
            ...
            # Edge cases
            @test (@inferred CTBase.Descriptions.find_similar_descriptions((), ())) isa
                Vector{String}
        end
        ...
        @testset "format_description_candidates - boundaries" begin
            ...
            formatted = CTBase.Descriptions.format_description_candidates(
            ...
            # max_show=1
            formatted4 = CTBase.Descriptions.format_description_candidates(
        ...
        @testset "format_description_candidates - edge cases" begin
            # Empty descriptions
            @test isempty(CTBase.Descriptions.format_description_candidates(()))
        ...
        @testset "Type stability - format_description_candidates" begin
            ...
            @test (@inferred CTBase.Descriptions.format_description_candidates(
                descriptions
            )) isa Vector{String}
            @test (@inferred CTBase.Descriptions.format_description_candidates(
            ...
            # Edge case
            @test (@inferred CTBase.Descriptions.format_description_candidates(())) isa
                Vector{String}
        end
    end
end

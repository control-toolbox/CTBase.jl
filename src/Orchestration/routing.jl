...
See also: [`CTBase.Orchestration.extract_strategy_ids`](@extref), [`CTBase.Orchestration.build_strategy_to_family_map`](@extref), [`CTBase.Orchestration.build_option_ownership_map`](@extref)
"""

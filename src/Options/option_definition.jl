...
struct OptionDefinition{T}
    ...
    function OptionDefinition{T}(;
        ...
        if validator !== nothing && !(default isa _Core.NotProvidedType)
            try
                validator(default)
            catch e
...
function _construct_option_definition(
    name::Symbol,
    type::Type,
    default::_Core.NotProvidedType,
    description::String,
    aliases::Tuple{Vararg{Symbol}},
    validator::Union{Function,Nothing},
    computed::Bool,
)
    return OptionDefinition{_Core.NotProvidedType}(;
        name=name,
        type=type,
        default=default,
        description=description,
...
"""
is_required(def::OptionDefinition) = def.default isa _Core.NotProvidedType
...
"""
has_default(def::OptionDefinition) = !(def.default isa _Core.NotProvidedType)

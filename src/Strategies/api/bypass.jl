...
See also: [`CTBase.Strategies.bypass`](@extref)
"""
...
See also: [`CTBase.Strategies.BypassValue`](@extref), [`CTBase.Strategies.route_to`](@extref), [`CTBase.Strategies.force`](@extref)
"""
...
See also: [`CTBase.Strategies.BypassValue`](@extref), [`CTBase.Strategies.bypass`](@extref), [`CTBase.Strategies.route_to`](@extref)
"""
const force = bypass

...
See also: [`CTBase.Strategies.filter_options`](@extref)
"""
...
See also: [`CTBase.Strategies.options`](@extref), [`CTBase.Strategies.options_dict`](@extref)
"""
...
See also: [`CTBase.Strategies.resolve_alias`](@extref), [`CTBase.Strategies.levenshtein_distance`](@extref)
"""
...
See also: [`CTBase.Strategies.suggest_options`](@extref)
"""

...
See also: [`CTBase.Strategies.route_to`](@extref)
"""
struct RoutedOption
    routes::NamedTuple
...
See also: [`CTBase.Strategies.RoutedOption`](@extref), [`CTBase.Orchestration.route_all_options`](@extref)
"""
...
See also: [`CTBase.Strategies.route_to`](@extref), [`CTBase.Strategies.RoutedOption`](@extref)
"""
